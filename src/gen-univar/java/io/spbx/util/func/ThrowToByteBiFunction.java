 ...
 * This is the {@code byte}-producing primitive specialization for {@link ThrowBiFunction}.
 * <p>
 * The {@code ThrowToByteBiFunction} interface is similar to
 * {@link java.util.function.ToByteBiFunction}, except that a {@code ThrowToByteBiFunction}
...
public interface ThrowToByteBiFunction<T, U, E extends Throwable> {
     ...
     */
    byte applyAsByte(T left, U right) throws E;
}

...
public interface BiCharObjFunction<T, R> extends BiFunction<Character, T, R> {
    /**
     ...
     */
    R apply(char left, T right);

    @Override
    default R apply(Character left, T right) {
        return apply((char) left, right);
    }
}

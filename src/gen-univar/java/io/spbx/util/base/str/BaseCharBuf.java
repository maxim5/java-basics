...
public abstract class BaseCharBuf<B extends BaseCharBuf> extends BaseBuf implements Comparable<B>, Serializable {
    ...
    @AllowPythonIndexing
    public int indexOf(char val, @PyIndex int from) {
        return this.indexOf(val, from, -1);
    }

    @AllowPythonIndexing
    public int indexOf(char val, @PyIndex int from, int def) {
    ...
    @AllowPythonIndexing
    public int indexOf(char[] array, @PyIndex int from) {
        return this.indexOf(array, from, -1);
    }

    @AllowPythonIndexing
    public int indexOf(char[] array, @PyIndex int from, int def) {
    ...
    @AllowPythonIndexing
    public int lastIndexOf(char val, @PyIndex int from) {
        return this.lastIndexOf(val, from, -1);
    }

    @AllowPythonIndexing
    public int lastIndexOf(char val, @PyIndex int from, int def) {
    ...
    @AllowPythonIndexing
    public int lastIndexOf(char[] array, @PyIndex int from) {
        return this.lastIndexOf(array, from, -1);
    }

    @AllowPythonIndexing
    public int lastIndexOf(char[] array, @PyIndex int from, int def) {
    ...
    @AllowPythonIndexing
    protected abstract @NotNull B _wrap(char @NotNull[] chars, @PyIndex int start, @PyIndex int end);
}

 ...
 * @see Lazy
 */
public interface LazyInit<T> extends Supplier<T> {
    /**
     ...
     */
    void compareAndInitialize(@NotNull T value);
    ...
    /**
     * Returns the value if this instance has been initialized, otherwise throws an error.
     */
    @NotNull T getOrDie();

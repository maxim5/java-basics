...
public final class Array<E> extends BaseArray<E> {
    ...
    public static final class Builder<E> extends BaseBuilder<E> {
        ...
        public static @SafeVarargs <E> @NotNull Builder<E> of(@NotNull E @Nullable ... items) {
        ...
        @Override public @NotNull Builder<E> add(@Nullable E item) {
            super.add(item);
            return this;
        }

        @Override public @NotNull Builder<E> addAll(@NotNull Collection<? extends E> items) {
            super.addAll(items);
            return this;
        }

        @SuppressWarnings("unchecked")
        @Override public @NotNull Builder<E> addAll(@Nullable E @NotNull ... items) {
            super.addAll(items);
            return this;
        }

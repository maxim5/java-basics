...
public class MapBuilder<K, V> implements ToMapKvApi<K, V, Entry<K, V>> {
    ...
    public @NotNull MapBuilder<K, V> putMultiKeys(@Nullable K key1, @Nullable K key2, @Nullable V val) {
        return put(key1, val, key2, val);
    }

    public @NotNull MapBuilder<K, V> putMultiKeys(@Nullable K key1, @Nullable K key2, @Nullable K key3, @Nullable V val) {
        return put(key1, val, key2, val, key3, val);
    }

    public @NotNull MapBuilder<K, V> putMultiKeys(@Nullable K key1, @Nullable K key2, @Nullable K key3, @Nullable K key4,
                                                  @Nullable V val) {
        return put(key1, val, key2, val, key3, val, key4, val);
    }

    public @NotNull MapBuilder<K, V> putMultiKeys(@Nullable K key1, @Nullable K key2, @Nullable K key3,
                                                  @Nullable K key4, @Nullable K key5, @Nullable V val) {
        return put(key1, val, key2, val, key3, val, key4, val, key5, val);
    }

    public @NotNull MapBuilder<K, V> putMultiKeys(@Nullable Iterable<@Nullable K> keys, @Nullable V val) {
        if (keys != null) {
            keys.forEach(key -> put(key, val));
        }
        return this;
    }
    ...
    public @NotNull MapBuilder<K, V> overwriteMultiKeys(@Nullable K key1, @Nullable K key2, @Nullable V val) {
        return overwrite(key1, val, key2, val);
    }

    public @NotNull MapBuilder<K, V> overwriteMultiKeys(@Nullable K key1, @Nullable K key2, @Nullable K key3,
                                                        @Nullable V val) {
        return overwrite(key1, val, key2, val, key3, val);
    }

    public @NotNull MapBuilder<K, V> overwriteMultiKeys(@Nullable K key1, @Nullable K key2, @Nullable K key3,
                                                        @Nullable K key4, @Nullable V val) {
        return overwrite(key1, val, key2, val, key3, val, key4, val);
    }

    public @NotNull MapBuilder<K, V> overwriteMultiKeys(@Nullable K key1, @Nullable K key2, @Nullable K key3,
                                                        @Nullable K key4, @Nullable K key5, @Nullable V val) {
        return overwrite(key1, val, key2, val, key3, val, key4, val, key5, val);
    }

    public @NotNull MapBuilder<K, V> overwriteMultiKeys(@Nullable Iterable<@Nullable K> keys, @Nullable V val) {
        if (keys != null) {
            keys.forEach(key -> overwrite(key, val));
        }
        return this;
    }

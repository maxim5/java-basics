...
public class ArrayTest {
    ...
    public void array_builder_of_add_all_list() {
        Array<String> array = Array.Builder.of("1", "2").addAll(listOf("3", "4")).toArray();
    ...
    public void array_add_throws() {
        ...
        assertThrows(UnsupportedOperationException.class, () -> Array.of(1, 2, 3).addAll(listOf(4, 5)));
    }
    ...
    public void array_remove_throws() {
        ...
        assertThrows(UnsupportedOperationException.class, () -> Array.of("1").removeAll(listOf("1", "2")));
    ...
    private static @SafeVarargs <T> void assertArray(@NotNull Array<T> array, @Nullable T @NotNull ... expected) {

...
public class IntOpsByteBufferJmhBenchmark {
    ...
    @Benchmark
    public void byte_buffer_wrap_as_int_buffer(Blackhole blackhole) {
    ...
    @Benchmark
    public void array_iteration(Blackhole blackhole) {
        for (int iter = 0; iter < LOOP; ++iter) {
            byte[] bytes = BYTE_ARRAY;
    ...
    public static void main(String[] args) throws RunnerException {
        ...
        Options options = new OptionsBuilder().include(IntOpsByteBufferJmhBenchmark.class.getSimpleName()).build();

...
public class TripleTest {
    ...
    public void triple_simple_constructors() {
        ...
        assertTriple(Triple.dupe(1)).holds(1, 1, 1);

        assertThat(Triple.of(null, null, null)).isSameInstanceAs(Triple.empty());
        assertThat(Triple.dupe(null)).isSameInstanceAs(Triple.empty());
    }
